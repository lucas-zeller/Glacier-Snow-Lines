...
# big_folder = os.path.join('C:',os.sep,'Users','lzell','OneDrive - Colostate','Desktop','AGVA','classified images','L8 Classified Images no PC 2013')
# length = 32

# PC classified images
# big_folder = os.path.join('C:',os.sep,'Users','lzell','OneDrive - Colostate','Desktop','AGVA','classified images','L8 Classified Images PC 2013')
# length = 35
