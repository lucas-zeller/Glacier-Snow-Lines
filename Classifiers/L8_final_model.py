...
#%%
upload_model = 1
model_name = "random_forest_L8_TOA"
...
predictors = [
                'coastal', 'blue', 'green', 'red', 'nir', 'swir1', 'swir2', 'ndsi', 'ndwi',
                'SO_coastal', 'SO_blue', 'SO_green', 'SO_red', 'SO_nir', 'SO_swir1', 'SO_swir2', 'SO_ndsi', 'SO_ndwi',
                'DN_coastal', 'DN_blue', 'DN_green', 'DN_red', 'DN_nir', 'DN_swir1', 'DN_swir2', 'DN_ndsi', 'DN_ndwi',
              ]
